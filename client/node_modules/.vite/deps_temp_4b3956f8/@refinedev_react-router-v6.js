...
var D = { go: () => {
  ...
  var c;
  let e = useParams(), { pathname: t, search: r } = useLocation(), { resources: i } = (0, import_react2.useContext)(nt), { resource: s, action: n, matchedRoute: o } = import_react.default.useMemo(() => Lo(t, i), [i, t]);
...
var q = ({ resource: e, meta: t }) => {
  let r = pt(), { resource: i, resources: s } = N(e), n = i || s.find((o) => o.list);
  if (n) {
...
var _2 = ({ translationKey: e = "warnWhenUnsavedChanges", message: t = "Are you sure you want to leave? You have unsaved changes." }) => {
  let r = _(), { pathname: i } = useLocation(), { warnWhen: s, setWarnWhen: n } = Kt();
...
function ce({ handler: e }) {
  var m;
  let t = useLocation(), { action: r, id: i, params: s, pathname: n, resource: o } = fe(), a = _(), c = bt(), f = (o == null ? void 0 : o.identifier) ?? (o == null ? void 0 : o.name), u = (o == null ? void 0 : o.label) ?? ((m = o == null ? void 0 : o.meta) == null ? void 0 : m.label) ?? c(f, r === "list" ? "plural" : "singular");
