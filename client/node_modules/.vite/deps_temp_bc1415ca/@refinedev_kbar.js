...
var I = r(() => {
  let n = _(), { resource: e, resources: p, id: c, action: y } = N(), l = q(), d = pt(), b = le(), { mutate: H } = na(), { push: K, list: Pt, create: wt, show: Tt, edit: kt } = pe(), V = bt(), $ = (0, import_react3.useContext)(import_kbar3.KBarContext), { can: a } = YC(), [B, q2] = (0, import_react3.useState)([]);
