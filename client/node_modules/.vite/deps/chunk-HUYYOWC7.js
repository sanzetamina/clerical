...
var C = m(({ refineCoreProps: t, warnWhenUnsavedChanges: a, disableServerSideValidation: p = false, ...Q } = {}) => {
  let { options: F } = oe(), S = (F == null ? void 0 : F.disableServerSideValidation) || p, U = _(), { warnWhenUnsavedChanges: h, setWarnWhen: b } = Kt(), f = a ?? h, d = useForm({ ...Q }), { watch: c, setValue: R, getValues: i, handleSubmit: T, setError: x } = d, E = ax({ ...t, onMutationError: (r, s, e) => {
    var v, H;
    if (S) {
      (v = t == null ? void 0 : t.onMutationError) == null || v.call(t, r, s, e);
      return;
    }
    let y = r == null ? void 0 : r.errors;
    for (let V in y) {
      if (!Object.keys(Tr(s)).includes(V))
        continue;
      let u = y[V], D = "";
  ...
  (0, import_react2.useEffect)(() => {
    ...
    if (!r)
      return;
    Object.keys(Tr(i())).forEach((y) => {
      let v = has_default(r, y), H = get_default(r, y);
      v && R(y, H);
    });
  }, [l == null ? void 0 : l.data, R, i]), (0, import_react2.useEffect)(() => {
    let r = c((s, { type: e }) => {
      e === "change" && W(s);
    });
  ...
  let W = m((r) => {
    ...
    if (f && b(true), t != null && t.autoSave) {
      b(false);
      let e = (s = t.autoSave) == null ? void 0 : s.onFinish;
      return j(e ? e(r) : r);
    }
    return r;
  }, "onValuesChange"), g = m((r, s) => async (e) => (b(false), T(r, s)(e)), "handleSubmit");
  return { ...d, handleSubmit: g, refineCore: E, saveButtonProps: { disabled: B, onClick: (r) => {
    g(o, () => false)(r);
  } } };
}, "useForm");
var ie = m(({ stepsProps: t, ...a } = {}) => {
  let { defaultStep: p = 0, isBackValidate: Q = false } = t ?? {}, [F, S] = (0, import_react3.useState)(p), U = C({ ...a }), { trigger: h, getValues: b, setValue: f, formState: { dirtyFields: d }, refineCore: { queryResult: c } } = U;
...
var xe = m(({ modalProps: t, refineCoreProps: a, syncWithLocation: p, ...Q } = {}) => {
  var A, N2;
  let F = Ce(), [S, U] = import_react5.default.useState(false), h = _(), { resource: b, action: f } = a ?? {}, { resource: d, action: c, identifier: R } = N(b), i = fe(), T = le(), x = bt(), E = f ?? c ?? "", l = !(typeof p == "object" && (p == null ? void 0 : p.syncId) === false), o = typeof p == "object" && "key" in p ? p.key : d && E && p ? `modal-${R}-${E}` : void 0, { defaultVisible: B = false, autoSubmitClose: j = true, autoResetForm: W = true } = t ?? {}, g = C({ refineCoreProps: { ...a, meta: { ...o ? { [o]: void 0 } : {}, ...a == null ? void 0 : a.meta } }, ...Q }), { reset: $, refineCore: { onFinish: r, id: s, setId: e, autoSaveProps: y }, saveButtonProps: v, handleSubmit: H } = g, { visible: V, show: k, close: u } = uC({ defaultVisible: B });
  import_react5.default.useEffect(() => {
    var n, w, K, I;
    if (S === false && o) {
      let M = (w = (n = i == null ? void 0 : i.params) == null ? void 0 : n[o]) == null ? void 0 : w.open;
      if (typeof M == "boolean" ? M && k() : typeof M == "string" && M === "true" && k(), l) {
        let G = (I = (K = i == null ? void 0 : i.params) == null ? void 0 : K[o]) == null ? void 0 : I.id;
        G && (e == null || e(G));
      }
      U(true);
    }
  }, [o, i, l, e]), import_react5.default.useEffect(() => {
    var n;
    S === true && (V && o ? T({ query: { [o]: { ...(n = i == null ? void 0 : i.params) == null ? void 0 : n[o], open: true, ...l && s && { id: s } } }, options: { keepQuery: true }, type: "replace" }) : o && !V && T({ query: { [o]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [s, V, k, o, l]);
  let D = m(async (n) => {
    await r(n), j && u(), W && $();
  }, "submit"), { warnWhen: O, setWarnWhen: X } = Kt(), Z = (0, import_react4.useCallback)(() => {
    var n;
    if (y.status === "success" && ((n = a == null ? void 0 : a.autoSave) != null && n.invalidateOnClose) && F({ id: s, invalidates: a.invalidates || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: R }), O)
      if (window.confirm(h("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        X(false);
      else
        return;
    e == null || e(void 0), u();
  }, [O, y.status]), _2 = (0, import_react4.useCallback)((n) => {
    typeof n < "u" && (e == null || e(n)), (!(E === "edit" || E === "clone") || (typeof n < "u" || typeof s < "u")) && k();
  }, [s]), q = h(`${R}.titles.${f}`, void 0, `${x(`${f} ${((A = d == null ? void 0 : d.meta) == null ? void 0 : A.label) ?? ((N2 = d == null ? void 0 : d.options) == null ? void 0 : N2.label) ?? (d == null ? void 0 : d.label) ?? R}`, "singular")}`);
  return { modal: { submit: D, close: Z, show: _2, visible: V, title: q }, ...g, saveButtonProps: { ...v, onClick: (n) => H(D)(n) } };
}, "useModalForm");
...
//# sourceMappingURL=chunk-HUYYOWC7.js.map
