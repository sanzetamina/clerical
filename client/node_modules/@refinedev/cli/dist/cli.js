...
`+t+`
`+e.slice(o+(n==null?void 0:n.statement.length))};var Mt=require("fs-extra"),Lt=require("path");function ue(e){if(this!=null&&this.absolutePackageDir)try{return(0,Mt.readFileSync)((0,Lt.join)(this.absolutePackageDir,e)).toString()}catch{return}}var Bt=require("module"),Po=Bt.prototype.require,Vt=(e,t)=>{Bt.prototype.require=function(...r){return r[0]==="@refinedev/cli"?{...Ae,getFileContent:n=>ue.call({absolutePackageDir:t?e:zt.default.join(process.cwd(),e)},n)}:Po.apply(this,r)}};var je=async(e,t)=>{try{return Vt(e,t),require(De.default.join(t?e:De.default.join(process.cwd(),e),"refine.config.js"))}catch{return}};var Kt=i(require("dedent"));var E={SUCCESS:"SUCCESS",UNKNOWN_ERROR:"UNKNOWN_ERROR",SOURCE_PATH_NOT_FOUND:"SOURCE_PATH_NOT_FOUND",TARGET_PATH_NOT_FOUND:"TARGET_PATH_NOT_FOUND",SOURCE_PATH_NOT_A_FILE:"SOURCE_PATH_NOT_A_FILE",TARGET_ALREADY_EXISTS:"TARGET_ALREADY_EXISTS"};var y=i(require("chalk"));var Wt=i(require("chalk")),Yt=i(require("cardinal")),qt=i(require("boxen")),Eo=e=>{let t=/^(?:\/\/\s?title:\s?)(.*?)\n/g,[r,n]=t.exec(e)??[];if(n){let o=n.trim(),s=e.replace(r||"","");return{title:o,code:s}}return{code:e}},Jt=e=>{let{title:t,code:r}=Eo(e),n="";try{n=Yt.default.highlight(r,{jsx:!0})}catch{n=r}return(0,qt.default)(n,{padding:1,margin:0,borderStyle:"round",borderColor:"gray",titleAlignment:"left",title:t?Wt.default.bold(t):void 0})};var Xt=require("marked"),Ht=i(require("marked-terminal")),fe=e=>(0,Xt.marked)(e,{renderer:new Ht.default({code:Jt})});var Gt=({label:e,files:t,message:r="**`Warning:`** You should use the component where you want to use it."})=>{let n=t.filter(([,l])=>Object.values(E).filter(u=>u!==E.SUCCESS).includes(l)),o="success";switch(n.length){case 0:o="success";break;case t.length:o="error";break;default:o="warning";break}let s=l=>{let u=l==null?void 0:l.replace(process.cwd(),"");return u!=null&&u.startsWith("/")?u.slice(1):u!=null&&u.startsWith("./")?u.slice(2):u},c=()=>{switch(o){case"success":console.log(y.default.blueBright(`Successfully swizzled ${y.default.bold(e)}`));return;case"warning":console.log(y.default.yellowBright(`Swizzle completed with errors for ${y.default.bold(e)}`));return;case"error":console.log(y.default.redBright(`Swizzle failed for ${y.default.bold(e)}`));return;default:return}},a=()=>{let l=[];l.push(y.default.dim(`File${t.length>1?"s":""} created:`)),l.push(t.map(([u,v])=>v===E.SUCCESS?y.default.cyanBright.dim(` - ${s(u)}`):v===E.TARGET_ALREADY_EXISTS?y.default.cyanBright.dim(` - ${y.default.yellowBright.bold("[FILE_ALREADY_EXISTS] ")}${s(u)}`):v===E.SOURCE_PATH_NOT_A_FILE?y.default.cyanBright.dim(` - ${y.default.yellowBright.bold("[SOURCE NOT FOUND] ")}${s(u)}`):y.default.cyanBright.dim(` - ${y.default.yellowBright.bold(`[${v}]`)}${s(u)}`)).join(`
`)),console.log(l.join(`
...
You can install them manually by running this command:`),console.log(tr.default.bold.blueBright(o))};var Co=e=>e.command("swizzle").description(`Export a component or a function from ${L.default.bold("refine")} packages to customize it in your project`).action(No),or=e=>(t,r="")=>e.filter(o=>{var s;return o.label.toLowerCase().includes(r.toLowerCase())||((s=o.group)==null?void 0:s.toLowerCase().includes(r.toLowerCase()))}).flatMap((o,s,c)=>{var l;return[...(o==null?void 0:o.group)&&((l=c[s-1])==null?void 0:l.group)!==o.group&&o.group?[new ee.default.Separator(`${L.default.bold(o.group)}`)]:[],{name:` ${o.label}`,value:o!=null&&o.value?o.value:o}]}),No=async e=>{var u,v,P;ee.default.registerPrompt("autocomplete",nr.default);let t=await K(),r=[];if(await Promise.all(t.map(async d=>{let p=await qe(d.path),m=r.findIndex(f=>f.name===d.name)===-1;p&&m&&r.push(d)})),r.length===0){console.log("No refine packages found with swizzle configuration.");return}console.log(`${(0,sr.default)(`Found ${L.default.blueBright(r.length)} installed ${L.default.blueBright.bold("refine")} packages with swizzle configuration.`,{padding:1,textAlignment:"center",dimBorder:!0,borderColor:"blueBright",borderStyle:"round"})}
`);let n=await Promise.all(r.map(async d=>{let p=await je(d.path,!0)??await je(d.path,!1)??{swizzle:{items:[]}};return{...d,config:p}})),{selectedPackage:o}=await ee.default.prompt([{type:"autocomplete",pageSize:10,name:"selectedPackage",message:"Which package do you want to swizzle?",emptyText:"No packages found.",source:or(n.sort((d,p)=>{var m,f;return(((m=d.config)==null?void 0:m.group)??"").localeCompare(((f=p.config)==null?void 0:f.group)??"")}).map(d=>{var p,m;return{label:((p=d.config)==null?void 0:p.name)??d.name,value:d,group:(m=d.config)==null?void 0:m.group}}))}]),{swizzle:{items:s,transform:c}}=o.config,a;if(s.length===0){console.log(`No swizzle items found for ${L.default.bold(((u=o.config)==null?void 0:u.name)??o.name)}`);return}else s.length===1?a=s[0]:s.length>1&&(a=(await ee.default.prompt([{type:"list",pageSize:10,name:"selectedComponent",message:"Which component do you want to swizzle?",emptyText:"No components found.",choices:or(s.sort((p,m)=>p.group.localeCompare(m.group)))({},"")}])).selectedComponent);if(!a){console.log(`No swizzle items selected for ${L.default.bold(((v=o.config)==null?void 0:v.name)??o.name)}`);return}let g=Qt(),l=await Promise.all(a.files.map(async d=>{var p;try{let m=d.src?$e.default.join(o.path,d.src):void 0,f=d.dest?$e.default.join(process.cwd(),g,d.dest):void 0;if(!m)return console.log("No src path found for file",d),["",E.SOURCE_PATH_NOT_FOUND];if(!f)return console.log("No destination path found for file",d),["",E.TARGET_PATH_NOT_FOUND];if(!await(0,D.pathExists)(m))return[f,E.SOURCE_PATH_NOT_A_FILE];let R=await(0,D.readFile)(m,"utf-8");if(await(0,D.pathExists)(f))return[f,E.TARGET_ALREADY_EXISTS];await(0,D.ensureFile)(f);let b=Zt(R),ve=((p=d.transform)==null?void 0:p.call(d,b))??b,we=(c==null?void 0:c(ve,m,f))??ve,kr=Ut(we),br=await Ie(kr);return await(0,D.writeFile)(f,br),[f,E.SUCCESS]}catch{return["",E.UNKNOWN_ERROR]}}));l.length>0&&(Gt({files:l,label:a.label,message:a.message}),(P=a==null?void 0:a.requiredPackages)!=null&&P.length&&await rr(a.requiredPackages))},ar=Co;var lr=require("commander");var J=i(require("inquirer")),Ue=i(require("semver-diff")),ge=i(require("chalk"));var ir=e=>{let t=e.filter((n,o)=>e.indexOf(n)!==o),r=new Set(t);return Array.from(r)};var cr=async e=>{let t=bo(e);if(!t){console.log("All `refine` packages are up to date. \u{1F389}");return}let r=To(t),n=await J.default.prompt([{type:"checkbox",name:"packages",message:"Choose packages to update",pageSize:r.pageSize,choices:r.choices,validate:ko}]);return n.packages.length>0?n.packages:null},ko=e=>{let r=e.map(o=>Xe(o)).map(o=>o.name),n=ir(r);return n.length>0?`You can't update the same package more than once. Please choice one.
 Duplicates: ${n.join(", ")}`:!0},bo=e=>{if(e.length===0)return null;let t={patch:[],minor:[],major:[]};return e.forEach(r=>{let n=r.current,o=(0,Ue.default)(n,r.wanted),s=(0,Ue.default)(n,r.latest);if(o===s&&s){t[s].push({name:r.name,from:n,to:r.latest});return}o&&t[o].push({name:r.name,from:n,to:r.wanted}),s&&t[s].push({name:r.name,from:n,to:r.latest})}),t},To=e=>{let t=0,r=0;[e.patch,e.minor,e.major].forEach(l=>{l.forEach(u=>{u.name.length>t&&(t=u.name.length),u.from.length>r&&(r=u.from.length)})}),t+=2;let n=[],o="Package".padEnd(t),s="From".padEnd(r),a=`
...
Major Updates`))),e.major.forEach(l=>{n.push({name:`${l.name.padEnd(t)} ${l.from.padStart(r)} -> ${l.to}`,value:`${l.name}@${l.to}`})}));let g=n.length+6;return{choices:n,pageSize:g}};var So=e=>e.command("update").description("Interactively select and update all `refine` packages to selected version. To skip the interactive mode, use the `--all` option.").addOption(new lr.Option("-t, --tag [tag]","Select version to update to.").choices(["next","latest"]).default("wanted","Version ranges in the `package.json` will be installed")).option("-a, --all","Update all `refine` packages to the selected `tag`. If `tag` is not provided, version ranges in the `package.json` will be installed. This option skips the interactive mode.",!1).option("-d, --dry-run","Get outdated packages installation command without automatic updating. If `tag` is not provided, version ranges in the `package.json` will be used.",!1).action(Oo),Oo=async e=>{let{tag:t,dryRun:r,all:n}=e,o=await j(Z,"Checking for updates...");if(!(o!=null&&o.length)){console.log("All `refine` packages are up to date \u{1F389}");return}let s=n?_o(t,o):await cr(o);if(s){if(r){Ao(s);return}Do(s)}},_o=(e,t)=>e==="wanted"&&t.every(o=>o.current===o.wanted)?(console.log("All `refine` packages are up to date with the wanted version \u{1F389}"),null):t.map(n=>{let o=e==="wanted"?n.wanted:e;return`${n.name}@${o}`}),Ao=async e=>{let t=await x(),r=U[t.name].install;console.log(`${t.name} ${r.join(" ")} ${e.join(" ")}`)},Do=e=>{console.log("Updating `refine` packages..."),console.log(e),oe(e)},pr=So;var mr=i(require("envinfo")),dr=i(require("ora")),jo=e=>e.command("whoami").description("View the details of the development environment").action($o),$o=async()=>{let e=(0,dr.default)("Loading environment details...").start(),t=await mr.default.run({System:["OS","CPU"],Binaries:["Node","Yarn","npm"],Browsers:["Chrome","Firefox","Safari"]},{showNotFound:!0,markdown:!0}),n=(await B()||[]).map(o=>` - ${o.name}: ${o.version}`).join(`
`);e.stop(),console.log(t),console.log("## Refine Packages:"),console.log(n)},ur=jo;var Le=require("commander");var X=require("fs-extra"),Fe=require("path");var z=`${__dirname}/../templates/provider`,Me=["auth","live","data","access-control","notification","i18n","audit-log"],fr=(e,t)=>{e.forEach(r=>{let{fileName:n,templatePath:o}=Uo(r),s=t??Fo(),c=(0,Fe.join)(s,n),a=(0,Fe.join)(process.cwd(),s,n);if((0,X.pathExistsSync)(a)){console.error(`\u274C Provider (${c}) already exist!`);return}(0,X.mkdirSync)(s,{recursive:!0}),(0,X.copySync)(o,a),console.log(`\u{1F389} Provider (${c}) created successfully!`)})},he={auth:{fileName:"auth-provider.tsx",templatePath:`${z}/demo-auth-provider.tsx`},live:{fileName:"live-provider.tsx",templatePath:`${z}/demo-live-provider.tsx`},data:{fileName:"data-provider.tsx",templatePath:`${z}/demo-data-provider.tsx`},"access-control":{fileName:"access-control-provider.tsx",templatePath:`${z}/demo-access-control-provider.tsx`},notification:{fileName:"notification-provider.tsx",templatePath:`${z}/demo-notification-provider.tsx`},i18n:{fileName:"i18n-provider.tsx",templatePath:`${z}/demo-i18n-provider.tsx`},"audit-log":{fileName:"audit-log-provider.tsx",templatePath:`${z}/demo-audit-log-provider.tsx`}},Uo=e=>{if(!(he!=null&&he[e]))throw new Error(`Invalid provider: ${e}`);return he[e]},Fo=()=>{let e=h(),{path:t}=at(e);return t};var Mo=e=>e.command("add").allowExcessArguments(!1).addArgument(new Le.Argument("[provider]","Create a new provider").choices([...Me,"resource"]).argOptional()).addArgument(new Le.Argument("[resource...]","Create a new resource files").argOptional()).option("-p, --path [path]","Path to generate files").option("-a, --actions [actions]","Only generate the specified resource actions. (ex: list,create,edit,show)","list,create,edit,show").action(Lo),Lo=async(e,t,r,n)=>{let o=n==null?void 0:n.args;if(!o.length){await Bo();return}let{providers:s,resources:c}=zo(o);s.length&&fr(s,r==null?void 0:r.path),o.includes("resource")&&le({actions:r==null?void 0:r.actions,path:r==null?void 0:r.path},c)},zo=e=>{let t=e.findIndex(o=>o==="resource");if(t===-1)return{providers:gr(e),resources:[]};let r=gr(e.slice(0,t)),n=e.slice(t+1);return{providers:r,resources:n}},Bo=async()=>{let{name:e}=await x();console.log("\u274C Please provide a feature name"),console.log(`For more information please use: "${e} run refine add help"`)},gr=e=>e.filter(t=>Me.includes(t)?!0:(console.log(`\u274C "${t}" is not a valid provider`),!1)),hr=Mo;var vr=i(require("envinfo")),wr=i(require("os")),Vo=()=>{let e=wr.default.type();return{Darwin:"macOS",Linux:"Linux",Windows_NT:"Windows"}[e]},yr=async()=>{let[e,t]=await vr.default.helpers.getOSInfo();return{name:Vo(),version:t}};var xr=i(require("node-fetch")),Wo=async()=>{let e=await yr();return{nodeEnv:C.NODE_ENV,nodeVersion:process.version,os:e.name,osVersion:e.version,command:process.argv[2],packages:await B()||[],projectFramework:h(),projectId:He()}},Pr=async()=>{if(C.REFINE_NO_TELEMETRY!=="true")try{let e=await Wo();await(0,xr.default)("https://telemetry.refine.dev/cli",{method:"POST",body:JSON.stringify(e),headers:{"Content-Type":"application/json"}})}catch{}};var Er=i(require("gray-matter")),Rr=i(require("boxen"));var Yo="https://raw.githubusercontent.com/refinedev/refine/master/packages/cli/ANNOUNCEMENTS.md",ze="---announcement",qo=e=>e.split(ze).slice(1).map(r=>`${ze}${r}`),Jo=e=>{let t=e.replace(ze,"---"),r=(0,Er.default)(t),n=(r.content.length===0?t.replace(/---/g,""):r.content.replace(/---/g,"")).trim();return{...r.data,content:n}},Xo=async()=>{try{let e=await fetch(Yo).then(r=>r.text()).catch(()=>"");return qo(e).map(r=>Jo(r))}catch{return[]}},Ir=async()=>{let t=(await Xo()).filter(n=>!n.hidden);if(t.length===0)return;let r=t.map(n=>{let o=t.length>1?"\u2014 ":"",s=fe(n.content);return`${o}${s}`}).join("").trim();console.log((0,Rr.default)(r,{padding:1,margin:0,borderStyle:"round",borderColor:"blueBright",titleAlignment:"left"}))};var Ho="1.0.0",Ko=()=>{let e=new Cr.Command;e.version(`@refinedev/cli@${Ho}`,"-v, --version","Output the current version.").description(Nr.default.textSync("refine",{font:"Isometric1",horizontalLayout:"full",verticalLayout:"full",whitespaceBreak:!0})).usage("<command> [options]").helpOption("-h, --help","Output usage information."),ar(e),dt(e),pr(e),Te(e),Se(e),Re(e),_e(e),ot(e),ur(e),gt(e),At(e),hr(e),e.hook("preAction",Ir),e.hook("postAction",t=>{let r=t.args[0];["run"].includes(r)||Pr()}),e.parse(process.argv),process.argv.slice(2).length||e.outputHelp()};Ko();
