...
export declare type ConsistencyRequestParametersConsistencyEnum = typeof ConsistencyRequestParametersConsistencyEnum[keyof typeof ConsistencyRequestParametersConsistencyEnum];
/**
 * @type ContinueWith
 * @export
 */
...
export declare type LoginFlowState = typeof LoginFlowState[keyof typeof LoginFlowState];
/**
 * Logout Flow
 * @export
...
export declare type MemberInviteStatusEnum = typeof MemberInviteStatusEnum[keyof typeof MemberInviteStatusEnum];
/**
 *
 * @export
 * @interface Message
...
export declare type RegistrationFlowState = typeof RegistrationFlowState[keyof typeof RegistrationFlowState];
/**
 *
 * @export
 ...
 * @export
 */
export declare type UpdateLoginFlowBody = UpdateLoginFlowWithCodeMethod | UpdateLoginFlowWithLookupSecretMethod | UpdateLoginFlowWithOidcMethod | UpdateLoginFlowWithPasswordMethod | UpdateLoginFlowWithTotpMethod | UpdateLoginFlowWithWebAuthnMethod;
/**
 ...
 * @export
 */
export declare type UpdateRegistrationFlowBody = UpdateRegistrationFlowWithCodeMethod | UpdateRegistrationFlowWithOidcMethod | UpdateRegistrationFlowWithPasswordMethod | UpdateRegistrationFlowWithWebAuthnMethod;
/**
...
export declare const FrontendApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    createBrowserLoginFlow(refresh?: boolean, aal?: string, returnTo?: string, cookie?: string, loginChallenge?: string, organization?: string, options?: any): AxiosPromise<LoginFlow>;
    /**
     * This endpoint initializes a browser-based user logout flow and a URL which can be used to log out the user.  This endpoint is NOT INTENDED for API clients and only works with browsers (Chrome, Firefox, ...). For API clients you can call the `/self-service/logout/api` URL directly with the Ory Session Token.  The URL is only valid for the currently signed in user. If no user is signed in, this endpoint returns a 401 error.  When calling this endpoint from a backend, please ensure to properly forward the HTTP cookies.
     * @summary Create a Logout URL for Browsers
     * @param {string} [cookie] HTTP Cookies  If you call this endpoint from a backend, please include the original Cookie header in the request.
     ...
     * @throws {RequiredError}
     */
    createBrowserRegistrationFlow(returnTo?: string, loginChallenge?: string, afterVerificationReturnTo?: string, organization?: string, options?: any): AxiosPromise<RegistrationFlow>;
    /**
     * This endpoint initializes a browser-based user settings flow. Once initialized, the browser will be redirected to `selfservice.flows.settings.ui_url` with the flow ID set as the query parameter `?flow=`. If no valid Ory Kratos Session Cookie is included in the request, a login flow will be initialized.  If this endpoint is opened as a link in the browser, it will be redirected to `selfservice.flows.settings.ui_url` with the flow ID set as the query parameter `?flow=`. If no valid user session was set, the browser will be redirected to the login endpoint.  If this endpoint is called via an AJAX request, the response contains the settings flow without any redirects or a 401 forbidden error if no valid session was set.  Depending on your configuration this endpoint might return a 403 error if the session has a lower Authenticator Assurance Level (AAL) than is possible for the identity. This can happen if the identity has password + webauthn credentials (which would result in AAL2) but the session has only AAL1. If this error occurs, ask the user to sign in with the second factor (happens automatically for server-side browser flows) or change the configuration.  If this endpoint is called via an AJAX request, the response contains the flow without a redirect. In the case of an error, the `error.id` of the JSON response body can be one of:  `security_csrf_violation`: Unable to fetch the flow because a CSRF violation occurred. `session_inactive`: No Ory Session was found - sign in a user first. `security_identity_mismatch`: The requested `?return_to` address is not allowed to be used. Adjust this in the configuration!  This endpoint is NOT INTENDED for clients that do not have a browser (Chrome, Firefox, ...) as cookies are needed.  More information can be found at [Ory Kratos User Settings & Profile Management Documentation](../self-service/flows/user-settings).
     * @summary Create Settings Flow for Browsers
     * @param {string} [returnTo] The URL to return the browser to after the flow was completed.
     ...
     * @throws {RequiredError}
     */
    listMySessions(perPage?: number, page?: number, pageSize?: number, pageToken?: string, xSessionToken?: string, cookie?: string, options?: any): AxiosPromise<Array<Session>>;
    /**
     * Use this endpoint to log out an identity using an Ory Session Token. If the Ory Session Token was successfully revoked, the server returns a 204 No Content response. A 204 No Content response is also sent when the Ory Session Token has been revoked already before.  If the Ory Session Token is malformed or does not exist a 403 Forbidden response will be returned.  This endpoint does not remove any HTTP Cookies - use the Browser-Based Self-Service Logout Flow instead.
     * @summary Perform Logout for Native Apps
     * @param {PerformNativeLogoutBody} performNativeLogoutBody
     ...
     * @throws {RequiredError}
     */
    toSession(xSessionToken?: string, cookie?: string, tokenizeAs?: string, options?: any): AxiosPromise<Session>;
    /**
     * Use this endpoint to complete a login flow. This endpoint behaves differently for API and browser flows.  API flows expect `application/json` to be sent in the body and responds with HTTP 200 and a application/json body with the session token on success; HTTP 410 if the original flow expired with the appropriate error messages set and optionally a `use_flow_id` parameter in the body; HTTP 400 on form validation errors.  Browser flows expect a Content-Type of `application/x-www-form-urlencoded` or `application/json` to be sent in the body and respond with a HTTP 303 redirect to the post/after login URL or the `return_to` value if it was set and if the login succeeded; a HTTP 303 redirect to the login UI URL with the flow ID containing the validation errors otherwise.  Browser flows with an accept header of `application/json` will not redirect but instead respond with HTTP 200 and a application/json body with the signed in identity and a `Set-Cookie` header on success; HTTP 303 redirect to a fresh login flow if the original flow expired with the appropriate error messages set; HTTP 400 on form validation errors.  If this endpoint is called with `Accept: application/json` in the header, the response contains the flow without a redirect. In the case of an error, the `error.id` of the JSON response body can be one of:  `session_already_available`: The user is already signed in. `security_csrf_violation`: Unable to fetch the flow because a CSRF violation occurred. `security_identity_mismatch`: The requested `?return_to` address is not allowed to be used. Adjust this in the configuration! `browser_location_change_required`: Usually sent when an AJAX request indicates that the browser needs to open a specific URL. Most likely used in Social Sign In flows.  More information can be found at [Ory Kratos User Login](https://www.ory.sh/docs/kratos/self-service/flows/user-login) and [User Registration Documentation](https://www.ory.sh/docs/kratos/self-service/flows/user-registration).
     * @summary Submit a Login Flow
     * @param {string} flow The Login Flow ID  The value for this parameter comes from &#x60;flow&#x60; URL Query parameter sent to your application (e.g. &#x60;/login?flow&#x3D;abcde&#x60;).
...
export declare const IdentityApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getIdentity: (id: string, includeCredential?: Array<'password' | 'totp' | 'oidc' | 'webauthn' | 'lookup_secret' | 'code'>, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listIdentities: (perPage?: number, page?: number, pageSize?: number, pageToken?: string, consistency?: '' | 'strong' | 'eventual', credentialsIdentifier?: string, previewCredentialsIdentifierSimilar?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const IdentityApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    deleteIdentityCredentials(id: string, type: 'totp' | 'webauthn' | 'lookup', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Calling this endpoint irrecoverably and permanently deletes and invalidates all sessions that belong to the given Identity.
     * @summary Delete & Invalidate an Identity\'s Sessions
     * @param {string} id ID is the identity\&#39;s ID.
     ...
     * @throws {RequiredError}
     */
    getIdentity(id: string, includeCredential?: Array<'password' | 'totp' | 'oidc' | 'webauthn' | 'lookup_secret' | 'code'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Identity>>;
    /**
     * Return a specific identity schema.
     * @summary Get Identity JSON Schema
     * @param {string} id ID must be set to the ID of schema you want to get
     ...
     * @throws {RequiredError}
     */
    listIdentities(perPage?: number, page?: number, pageSize?: number, pageToken?: string, consistency?: '' | 'strong' | 'eventual', credentialsIdentifier?: string, previewCredentialsIdentifierSimilar?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Identity>>>;
    /**
     * Returns a list of all identity schemas currently in use.
     * @summary Get all Identity Schemas
     * @param {number} [perPage] Deprecated Items per Page  DEPRECATED: Please use &#x60;page_token&#x60; instead. This parameter will be removed in the future.  This is the number of items per page.
...
export declare const IdentityApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    getIdentity(id: string, includeCredential?: Array<'password' | 'totp' | 'oidc' | 'webauthn' | 'lookup_secret' | 'code'>, options?: any): AxiosPromise<Identity>;
    /**
     * Return a specific identity schema.
     * @summary Get Identity JSON Schema
     * @param {string} id ID must be set to the ID of schema you want to get
     ...
     * @throws {RequiredError}
     */
    listIdentities(perPage?: number, page?: number, pageSize?: number, pageToken?: string, consistency?: '' | 'strong' | 'eventual', credentialsIdentifier?: string, previewCredentialsIdentifierSimilar?: string, options?: any): AxiosPromise<Array<Identity>>;
    /**
     * Returns a list of all identity schemas currently in use.
     * @summary Get all Identity Schemas
     * @param {number} [perPage] Deprecated Items per Page  DEPRECATED: Please use &#x60;page_token&#x60; instead. This parameter will be removed in the future.  This is the number of items per page.
     ...
     * @throws {RequiredError}
     */
    listIdentitySchemas(perPage?: number, page?: number, pageSize?: number, pageToken?: string, options?: any): AxiosPromise<Array<IdentitySchemaContainer>>;
    /**
     * This endpoint returns all sessions that belong to the given Identity.
     * @summary List an Identity\'s Sessions
     * @param {string} id ID is the identity\&#39;s ID.
     ...
     * @throws {RequiredError}
     */
    listIdentitySessions(id: string, perPage?: number, page?: number, pageSize?: number, pageToken?: string, active?: boolean, options?: any): AxiosPromise<Array<Session>>;
    /**
     * Listing all sessions that exist.
     * @summary List All Sessions
     * @param {number} [pageSize] Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination).
...
export interface IdentityApiGetIdentityRequest {
     ...
     * @memberof IdentityApiGetIdentity
     */
    readonly includeCredential?: Array<'password' | 'totp' | 'oidc' | 'webauthn' | 'lookup_secret' | 'code'>;
}
/**
...
export declare class IdentityApi extends BaseAPI {
     ...
     * @memberof IdentityApi
     */
    deleteIdentityCredentials(requestParameters: IdentityApiDeleteIdentityCredentialsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Calling this endpoint irrecoverably and permanently deletes and invalidates all sessions that belong to the given Identity.
     * @summary Delete & Invalidate an Identity\'s Sessions
...
export declare class OidcApi extends BaseAPI {
     ...
     * @memberof OidcApi
     */
    createVerifiableCredential(requestParameters?: OidcApiCreateVerifiableCredentialRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<VerifiableCredentialResponse>>;
    /**
     * This endpoint behaves like the administrative counterpart (`deleteOAuth2Client`) but is capable of facing the public internet directly and can be used in self-service. It implements the OpenID Connect Dynamic Client Registration Protocol. This feature needs to be enabled in the configuration. This endpoint is disabled by default. It can be enabled by an administrator.  To use this endpoint, you will need to present the client\'s authentication credentials. If the OAuth2 Client uses the Token Endpoint Authentication Method `client_secret_post`, you need to present the client secret in the URL query. If it uses `client_secret_basic`, present the Client ID and the Client Secret in the Authorization header.  OAuth 2.0 clients are used to perform OAuth 2.0 and OpenID Connect flows. Usually, OAuth 2.0 clients are generated for applications which want to consume your OAuth 2.0 or OpenID Connect capabilities.
     * @summary Delete OAuth 2.0 Client using the OpenID Dynamic Client Registration Management Protocol
...
export declare const ProjectApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    createOrganization(projectId: string, organizationBody?: OrganizationBody, options?: any): AxiosPromise<Organization>;
    /**
     * Creates a new project.
     * @summary Create a Project
     * @param {CreateProjectBody} [createProjectBody]
     ...
     * @throws {RequiredError}
     */
    deleteOrganization(projectId: string, organizationId: string, options?: any): AxiosPromise<void>;
    /**
     * Deletes an API token and immediately removes it.
     * @summary Delete project API token
     * @param {string} project The Project ID or Project slug
     ...
     * @throws {RequiredError}
     */
    getOrganization(projectId: string, organizationId: string, options?: any): AxiosPromise<GetOrganizationResponse>;
    /**
     * Get a projects you have access to by its ID.
     * @summary Get a Project
     * @param {string} projectId Project ID  The project\&#39;s ID.
     ...
     * @throws {RequiredError}
     */
    getProjectMembers(project: string, options?: any): AxiosPromise<Array<CloudAccount>>;
    /**
     * Retrieves project metrics for the specified event type and time range
     * @param {string} projectId Project ID
     * @param {string} eventType The event type to query for
     ...
     * @throws {RequiredError}
     */
    listOrganizations(projectId: string, options?: any): AxiosPromise<ListOrganizationsResponse>;
    /**
     * A list of all the project\'s API tokens.
     * @summary List a project\'s API Tokens
     * @param {string} project The Project ID or Project slug
     ...
     * @throws {RequiredError}
     */
    removeProjectMember(project: string, member: string, options?: any): AxiosPromise<void>;
    /**
     * Use this API to set your active project in the Ory Network Console UI.
     * @summary Sets the Ory Network Project active in the Ory Network Console
     * @param {SetActiveProjectInConsoleBody} [setActiveProjectInConsoleBody]
     ...
     * @throws {RequiredError}
     */
    updateOrganization(projectId: string, organizationId: string, organizationBody?: OrganizationBody, options?: any): AxiosPromise<Organization>;
};
/**
...
export declare class ProjectApi extends BaseAPI {
     ...
     * @memberof ProjectApi
     */
    createOrganization(requestParameters: ProjectApiCreateOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Organization>>;
    /**
     * Creates a new project.
     * @summary Create a Project
     ...
     * @memberof ProjectApi
     */
    deleteOrganization(requestParameters: ProjectApiDeleteOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Deletes an API token and immediately removes it.
     * @summary Delete project API token
     ...
     * @memberof ProjectApi
     */
    getOrganization(requestParameters: ProjectApiGetOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetOrganizationResponse>>;
    /**
     * Get a projects you have access to by its ID.
     * @summary Get a Project
     ...
     * @memberof ProjectApi
     */
    listOrganizations(requestParameters: ProjectApiListOrganizationsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListOrganizationsResponse>>;
    /**
     * A list of all the project\'s API tokens.
     * @summary List a project\'s API Tokens
     ...
     * @memberof ProjectApi
     */
    updateOrganization(requestParameters: ProjectApiUpdateOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Organization>>;
}
/**
